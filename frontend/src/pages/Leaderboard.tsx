...
// Models list uses real model IDs matching backend SUPPORTED_MODELS
...
const Leaderboard = () => {
    ...
    const handleInlineUpload = async (file: File) => {
        ...
        try {
            ...
            // Update URL params in-place (no full navigation)
            setSearchParams({
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="mb-8">
                    ...
                    <p className="text-xl text-muted-foreground">
                        Browse and select embedding models to benchmark
                    </p>
                </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Select models below, then upload a
                                        dataset to start benchmarking
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
